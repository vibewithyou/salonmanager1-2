...
const SalonBooking = () => {
  ...
  const handleBookingConfirm = async (data: {
    ...
    if (!selectedServiceData || !salonId) {
  ...
  const getOpeningHoursForDate = (): { open: string; close: string } | null => {
    if (!selectedDate || !salon?.opening_hours) return null;
  ...
  if (!salon) {
    return (
      <div className="min-h-screen bg-background flex flex-col items-center justify-center p-4">
        ...
        <h1 className="text-2xl font-display font-bold mb-2">{t('booking.salonNotFound')}</h1>
        <p className="text-muted-foreground mb-6">{t('booking.salonNotFoundDesc')}</p>
        <Button asChild>
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container px-4 py-8 max-w-4xl mx-auto">
        ...
        <div className="text-center mb-8 animate-fade-in">
          <div className="w-20 h-20 gradient-primary rounded-2xl mx-auto mb-4 flex items-center justify-center shadow-glow">
            <Scissors className="w-10 h-10 text-primary-foreground" />
          </div>
          <h1 className="text-3xl font-display font-bold mb-2">{salon.name}</h1>
          {salon.address && (
        ...
        <div className="animate-fade-in">
          ...
          {step === 3 && salonId && selectedServiceData && (
            <div className="space-y-6">
              <div className="text-center mb-8">
